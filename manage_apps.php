<?php 
    ...
    if(!isset($_GET['keyword'])){
      ...
      $query = "SELECT COUNT(*) as num FROM $tableName WHERE `app_name` LIKE '%$keyword%' OR `package_name` LIKE '%$keyword%'";

      $targetpage = "manage_apps.php?keyword=".$_GET['keyword'];
    ...
    if(!isset($_GET['keyword'])){
      $sql_query="SELECT * FROM tbl_apps ORDER BY tbl_apps.`id` DESC LIMIT $start, $limit"; 
    }
    else{

      $sql_query="SELECT * FROM tbl_apps WHERE `app_name` LIKE '%$keyword%' OR `package_name` LIKE '%$keyword%' ORDER BY tbl_apps.`id` DESC LIMIT $start, $limit"; 
    }
            ...
            <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-xxl-3 col-lg-3 col-md-3 col-sm-3" align="right">
                           <a href="add_apps.php?add=yes&amp;redirect=manage_apps.php">
                              <button class="btn btn-primary button" type="submit">Add App</button>
                            </a>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-12 mrg-top table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td style="word-break: break-all;"><?php echo $row['app_name']; ?></td>
                                        <td style="word-break: break-all;"><?php echo $row['package_name']; ?></td>
                                        ...
                                        <td nowrap="">
                                            <a href="add_apps.php?apps_id=<?php echo $row['id'];?>&redirect=<?=$redirectUrl?>"class="btn btn-primary btn_delete" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a>
