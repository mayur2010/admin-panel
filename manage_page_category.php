<?php 
    ...
    $page_title = "Manage Page Category";

    include("includes/header.php");
    require("includes/function.php");
    require("language/language.php");

    $tableName="tbl_page_category";   
    $targetpage = "manage_page_category.php"; 
    $limit = 12; 
    ...
    if(!isset($_GET['keyword'])){
      ...
      $query = "SELECT COUNT(*) as num FROM $tableName WHERE `page_name` LIKE '%$keyword%' OR `page_color` LIKE '%$keyword%'";

      $targetpage = "manage_page_category.php?keyword=".$_GET['keyword'];
    ...
    if(!isset($_GET['keyword'])){
      $sql_query="SELECT * FROM tbl_page_category ORDER BY tbl_page_category.`id` DESC LIMIT $start, $limit"; 
    }
    else{

      $sql_query="SELECT * FROM tbl_page_category WHERE `page_name` LIKE '%$keyword%'  OR `page_color` LIKE '%$keyword%' ORDER BY tbl_page_category.`id` DESC LIMIT $start, $limit"; 
    }
            ...
            <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-xxl-3 col-lg-3 col-md-3 col-sm-3" align="right">
                           <a href="add_page_category.php?add=yes&amp;redirect=manage_category.php">
                              <button class="btn btn-primary button" type="submit">Add Page Category</button>
                            </a>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-12 mrg-top table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td style="word-break: break-all;"><?php echo $row['page_name']; ?></td>
                                        <td style="word-break: break-all; background: <?php echo $row['page_color']; ?>; color: #ffffff;"><?php echo $row['page_color']; ?></td>
                                        ...
                                        <td nowrap="">
                                            <a href="add_page_category.php?page_id=<?php echo $row['id'];?>&redirect=<?=$redirectUrl?>"class="btn btn-primary btn_delete" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a>
