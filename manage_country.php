<?php 
    ...
    if(!isset($_GET['keyword'])){
      ...
      $query = "SELECT COUNT(*) as num FROM $tableName WHERE `country_name` LIKE '%$keyword%'";

      $targetpage = "manage_country.php?keyword=".$_GET['keyword'];
    ...
    if(!isset($_GET['keyword'])){
      $sql_query="SELECT * FROM tbl_country ORDER BY tbl_country.`id` DESC LIMIT $start, $limit"; 
    }
    else{

      $sql_query="SELECT * FROM tbl_country WHERE `country_name` LIKE '%$keyword%' ORDER BY tbl_country.`id` DESC LIMIT $start, $limit"; 
    }
            ...
            <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-xxl-3 col-lg-3 col-md-3 col-sm-3" align="right">
                           <a href="add_country.php?add=yes&amp;redirect=manage_country.php">
                              <button class="btn btn-primary button" type="submit">Add Country</button>
                            </a>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="col-md-12 mrg-top table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td style="word-break: break-all;"><?php echo $row['country_name']; ?></td>
                                        ...
                                        <td nowrap="">
                                            <a href="add_country.php?country_id=<?php echo $row['id'];?>&redirect=<?=$redirectUrl?>"class="btn btn-primary btn_delete" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a>
